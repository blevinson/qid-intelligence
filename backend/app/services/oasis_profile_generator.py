...
class OasisProfileGenerator:
    ...
    def __init__(
        ...
        # Graphiti-backed search for enriching entity context
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """Search the knowledge graph for entity context using Graphiti."""
        ...
        try:
            if self._graphiti_tools is None:
                ...
                self._graphiti_tools = ZepToolsService()
            ...
            logger.info(f"Graph search complete for {entity.name}: {len(results['facts'])} facts")
