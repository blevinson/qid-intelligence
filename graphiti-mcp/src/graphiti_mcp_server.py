        ...
        try:
            ...
            try:
                if self.config.database.provider.lower() == 'falkordb':
                    ...
                    # NoopCrossEncoder avoids the default OpenAIRerankerClient
                    # which requires OPENAI_API_KEY at construction time.
                    from llm import NoopCrossEncoder  # type: ignore[import-not-found]
